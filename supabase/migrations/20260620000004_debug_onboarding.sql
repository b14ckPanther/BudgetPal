...
DROP POLICY IF EXISTS debug_logs_policy ON public.debug_logs;
DROP POLICY IF EXISTS debug_logs_insert_policy ON public.debug_logs;
...
-- ── 2. Redefine handle_new_user_profile with exception logging and commit override ──
